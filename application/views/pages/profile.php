    			...
    			<div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
    				...
    				<div class="card">
    					...
    					<div class="card-body border-top">
    						<h3 class="font-16">User Profile</h3>
    						<div class="">
    												...
    												<?php foreach ($orders as $order) : ?>
    													<li class="list-group-item d-flex justify-content-between">
    														<div class="d-flex justify-content-between">
    															<img style="width:128px; max-height: 128px;object-fit: cover;" class="img-fluid" src="<?= base_url('assets/images/collections/') . $order->img; ?>" alt="gambar">
    															<div class="ml-3">
    																<h4 class="my-0"><?php echo $order->quantity . " " . $order->name; ?></h4>
    																<p>Ukuran <?php echo $order->size; ?> @Rp <?php echo idr_format($order->price); ?></p>
    																<p><strong>Alamat</strong> : <?php echo $order->address; ?></p>
    															</div>
    														</div>
    														<div>
    															<div>
    																<span style="font-size: 20px;" class="text-muted">Rp <?php echo idr_format($order->price * $order->quantity); ?></span>
    															</div>
    															<div class="align-left mt-2">
    																<span style="font-size: 16px;" class="text-muted"><?php echo status_button($order->status); ?></span>
    															</div>
    															<div class="text-center">
