												...
												<?php foreach ($orders as $order) : ?>
													<li class="list-group-item d-flex justify-content-between">
														<div class="d-flex justify-content-between">
															<img width="128px" height="128px" class="img-fluid" src="<?= base_url('assets/images/collections/') . $order->img ?>" alt="gambar">
															<div class="ml-3">
																<h4 class="my-0"><?php echo $order->name; ?></h4>
																<p><?php echo $order->size; ?> @Rp <?php echo idr_format($order->price); ?></p>
															</div>
														</div>
														<?php
														$status = 0;
														...
														<div>
															...
															<div class="align-left mt-2">
																<span style="font-size: 16px;" class="text-muted"><?php echo status_button($status); ?></span>
															</div>
														</div>
													</li>
												<?php endforeach; ?>
